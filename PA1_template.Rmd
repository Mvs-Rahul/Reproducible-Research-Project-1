...
```{r, echo = TRUE}
setwd("C:\Users\user\OneDrive\Desktop\Reproducible Research Project 1")
...
png("![figure1](https://user-images.githubusercontent.com/112823898/199019948-9e2ee626-9022-42d8-bf6c-b76b4fe1e5ee.png)")
...
png("![figure2](https://user-images.githubusercontent.com/112823898/199020281-ba31800e-f96d-4858-88b2-69171068fde3.png)")
qplot(Q2$`Total Steps`,geom="histogram",xlab="Total Steps",ylab="Counts",main="Total Steps Historgram")
dev.off()
```
...
png("![figure3](https://user-images.githubusercontent.com/112823898/199021585-dd0a07fc-9ec8-49ac-878f-180810f72ece.png)")
ggplot(Q4,aes(x=Q4$date,y=Q4$`Mean Steps`))+geom_bar(stat="identity")+scale_x_date()+ylab("Mean Steps Every day")+xlab("Date")+ggtitle("Mean Steps by Date")
dev.off()
```
...
```{r, echo = TRUE}
png("![figure4](https://user-images.githubusercontent.com/112823898/199021854-279270fd-82c3-4113-82da-cece55523cd3.png)")
...
png("![figure6](https://user-images.githubusercontent.com/112823898/199022229-cac716f5-ad01-44c0-91c1-360da3bf9398.png)")
...
png("![figure7](https://user-images.githubusercontent.com/112823898/199022387-092b4193-48c2-4daa-ac31-346ce7dcf7ed.png)")
xyplot(data=Q8.1,Steps~interval|WDWE, grid = TRUE, type = c("p", "smooth"), lwd = 4,panel = panel.smoothScatter)
dev.off()

png("![figure5](https://user-images.githubusercontent.com/112823898/199021947-3a21855f-e6d2-48f6-be5e-c4f1e1936149.png)")
hexbinplot(data=Q8.1,Steps~interval|WDWE, aspect = 1, bins=50)
dev.off()
```
